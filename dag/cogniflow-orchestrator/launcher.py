...
class ProcessTracker:
    ...
    def start(
        ...
        # Inherit current environment so CLAUDE_BIN, AGENT_TIMEOUT, etc. pass through
...
def run_launcher(config: LauncherConfig) -> None:
    ...
    log.info("=" * 56)
    log.info("  Cogniflow Launcher  v1.0.0")
    log.info("=" * 56)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--version", action="version", version="cogniflow-launcher 1.0.0",
    )
    return parser
